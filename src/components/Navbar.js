...
//           setLoad(false); // No results found
//         } else {
//           setLoad(false); // Results found
...
//   });
  ...
  return (
    <div className="ContainerNavbar">
      ...
      <div className="Cart">
        <button
          onClick={() => nav(`/cart`, { state: { categories: categories } })}
          className="CartCont"
          title="Cart"
        >
          <span>Cart {cart.length}</span>
          <img
            src="https://f.nooncdn.com/s/app/com/noon/icons/cart.svg"
            alt="cart"
          />
        </button>
      </div>
